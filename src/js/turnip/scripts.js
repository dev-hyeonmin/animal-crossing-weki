...
import { Predictor } from './predictions';
import {update_chart} from './chart';
...
let buy_input = null;
let sell_inputs = null;
let first_buy_radios = null;
let previous_pattern_radios = null;
let permalink_input = null;
let permalink_button = null;
let snackbar = null;

setTimeout(function () {
  buy_input = $("#buy");
  sell_inputs = getSellFields();
  first_buy_radios = getFirstBuyRadios();
  previous_pattern_radios = getPreviousPatternRadios();
  permalink_input = $('#permalink-input');
  permalink_button = $('#permalink-btn');
  snackbar = $('#snackbar');
}, 1000);
...
const calculateOutput = function (data, first_buy, previous_pattern) {
  ...
  for (let poss of analyzed_possibilities) {
    ...
    if (previous_pattern_number != poss.pattern_number) {
      ...
      let pattern_count = analyzed_possibilities
